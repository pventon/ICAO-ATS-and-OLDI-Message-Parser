...
class ParseF13(ParseFieldsCommon):
    ...
    def __init__(self, flight_plan_record, sfif, sfd):
        ...
        super().__init__(flight_plan_record,  # Flight plan to populate
                         ...
                         FieldIdentifiers.F13,  # ICAO field identifier
                         " \n\t\r",  # Whitespace to tokenize the field
                         # Subfields in this field
                         sfif.get_field_content_description(FieldIdentifiers.F13),
                         # Errors associated for this field
                         sfif.get_field_errors(FieldIdentifiers.F13))
    ...
    def parse_field(self):
        ...
        # Need split field 13a and 13b into the ADEP and EOBT
