...
class ParseOriginator(ParseFieldsCommon):
    ...
    def __init__(self, flight_plan_record, sfif, sfd):
        ...
        super().__init__(flight_plan_record,  # Flight plan to populate
                         ...
                         FieldIdentifiers.ORIGINATOR,  # ICAO field identifier
                         " \n\t\r",  # Whitespace to tokenize the field
                         # Subfields in this field
                         sfif.get_field_content_description(FieldIdentifiers.ORIGINATOR),
                         # Errors associated for this field
                         sfif.get_field_errors(FieldIdentifiers.ORIGINATOR))
