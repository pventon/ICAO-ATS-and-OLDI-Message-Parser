...
class ParseAddressee(ParseFieldsCommon):

    def __init__(self, flight_plan_record, sfif, sfd):
        # type: (FlightPlanRecord, SubFieldsInFields, SubFieldDescriptions) -> None
        """Constructor to set up the field parser for the message header 'addressee' field.
        Arguments
        ---------
        ...
        super().__init__(flight_plan_record,  # Flight plan to populate
                         ...
                         FieldIdentifiers.ADDRESS,  # ICAO field identifier
                         " \n\t\r",  # Whitespace to tokenize the field
                         # Subfields in this field
                         sfif.get_field_content_description(FieldIdentifiers.ADDRESS),
                         # Errors associated for this field
                         sfif.get_field_errors(FieldIdentifiers.ADDRESS))
