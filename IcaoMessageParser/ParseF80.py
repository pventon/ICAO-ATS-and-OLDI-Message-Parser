...
class ParseF80(ParseFieldsCommon):
    ...
    def __init__(self, flight_plan_record, sfif, sfd):
        ...
        super().__init__(flight_plan_record,  # Flight plan to populate
                         ...
                         FieldIdentifiers.F80,  # ICAO field identifier
                         " \n\t\r",  # Whitespace to tokenize the field
                         # Subfields in this field
                         sfif.get_field_content_description(FieldIdentifiers.F80),
                         # Errors associated for this field
                         sfif.get_field_errors(FieldIdentifiers.F80))
    ...
    def parse_field(self):
        ...
        # Check if there are extra unwanted tokens after Field 80
