...
class ParsePriorityIndicator(ParseFieldsCommon):
    ...
    def __init__(self, flight_plan_record, sfif, sfd):
        ...
        super().__init__(flight_plan_record,  # Flight plan to populate
                         ...
                         FieldIdentifiers.PRIORITY_INDICATOR,  # ICAO field identifier
                         " \n\t\r",  # Whitespace to tokenize the field
                         # Subfields in this field
                         sfif.get_field_content_description(FieldIdentifiers.PRIORITY_INDICATOR),
                         # Errors associated for this field
                         sfif.get_field_errors(FieldIdentifiers.PRIORITY_INDICATOR))
